...
echo -e "\e[32mCurrent Doxygen version...\e[0m"
doxygen -v 2>&1
echo -e "\e[32mCurrent GraphViz (dot) version......\e[0m"
dot -V || true
echo -e "\e[32mCurrent TeXLive Version......\e[0m"
latex --version || true
...
echo -e "\e[32mCurrent Python Version......\e[0m"
python --version

# Update the style sheets
echo "::group::Updating style sheets"
echo -e "\e[32mUpdate the style sheets\e[0m"
...
echo -e "\e[32mGenerating library logos\e[0m"
...
echo -e "\e[32mCreating dox files from example file headers\e[0m"
...
echo -e "\e[32mGenerating Doxygen code documentation...\e[0m"
...
echo -e "\e[32mFixing errant xml section names in examples as generated by Doxygen...\e[0m"
...
# echo -e "\e[32mFixing copied function documentation in group documentation\e[0m"
...
echo -e "\n\n"
echo -e "\e[32mFinished running m.css with result code: $result_code_mcss\e[0m"
...
echo -e "\e[32mCopying function documentation\e[0m"
...
# delete stupid links
echo -e "\e[32mRemoving stupid sub-page links\e[0m"
...
# echo -e "\e[32mConverting the Doxygen output to an Arudino keywords file\e[0m"
