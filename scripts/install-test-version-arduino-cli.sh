...
echo "\e[32mDeleting any archived zips\e[0m"
rm -f home/arduino/downloads/${GITHUB_REPOSITORY#*/}.zip

echo "\e[32mDownloading library zip from ${LIBRARY_INSTALL_ZIP}\e[0m"
...
echo "\e[32mCreating a new directory for the testing version of the library\e[0m"
mkdir -p home/arduino/user/libraries/${GITHUB_REPOSITORY#*/}

echo "\e[32mMoving the unzipped library to the new directory\e[0m"
